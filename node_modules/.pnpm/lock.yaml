...
importers:
  ...
  .:
    dependencies:
      bullmq:
        specifier: ^6.0.2
        version: 6.0.2(ioredis@6.0.0)(pg@8.22.0)
      dotenv:
        specifier: ^17.4.2
        version: 17.4.2
      express:
...
packages:
  ...
  bullmq@6.0.2:
    resolution: {integrity: sha512-GxSZzr6CajI2BTNdf0I5sVnHmjm1ql44UBGrehawRiecvosziEGB++r0JiuwJcc8i4MqTvcc122fkGtPRsYTaw==}
...
snapshots:
  ...
  bullmq@6.0.2(ioredis@6.0.0)(pg@8.22.0):
    dependencies:
      cron-parser: 5.6.1
      msgpackr: 2.0.5
      node-abort-controller: 3.1.1
